...
export default function Calendar() {
  ...
  return (
    <div className="space-y-6">
      ...
      {selectedItem && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 p-2 sm:items-center sm:px-4">
          <div className="flex max-h-[95vh] w-full max-w-2xl flex-col overflow-hidden rounded-t-[28px] rounded-b-none border border-border bg-surface shadow-lg sm:max-h-[90vh] sm:rounded-[28px]">
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6">
              ...
              <div className="sticky bottom-0 mt-6 flex justify-end border-t border-border bg-surface pt-4">
                <Button className="w-full sm:w-auto" variant="secondary" onClick={() => setSelectedItem(null)}>
                  Close
                </Button>
              </div>
            </div>
